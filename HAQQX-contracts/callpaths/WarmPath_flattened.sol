...
/// @title Minimal ERC20 interface for HaqqX
...
// File: contracts/interfaces/IHaqqCondOracle.sol
...
// File: contracts/interfaces/IHaqqLpConduit.sol
...
// File: contracts/interfaces/IHaqqPermitOracle.sol
...
contract KnockoutCounter is LevelBook, PoolRegistry, AgentMask {
     ...
     *         their fees. */
    event HaqqKnockoutCross (bytes32 indexed pool, int24 indexed tick, bool isBid,
    ...
    function crossKnockout (bytes32 pool, bool isBid, int24 tick, 
        ...
        emit HaqqKnockoutCross(pool, tick, isBid, merkle.pivotTime_, merkle.feeMileage_,
