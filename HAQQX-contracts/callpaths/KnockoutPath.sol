...
contract KnockoutFlagPath is KnockoutCounter {
     ...
     *      context besides a proxy sidecar to HaqqXSwapDex.
     *
    ...
    function acceptHaqqXProxyRole (address, uint16 slot) public pure returns (bool) {
        return slot == HaqqXSlots.FLAG_CROSS_PROXY_IDX;
    }
...
contract KnockoutLiqPath is TradeMatcher, SettleLayer {
    ...
    function claimCmd (bytes32 pool, CurveMath.CurveState memory curve,
        ...
        // (See IHaqqXPermitOracle for more information)
     ...
     *         in the correct slot. */
    function acceptHaqqXProxyRole (address, uint16 slot) public pure returns (bool) {
        return slot == HaqqXSlots.KNOCKOUT_LP_PROXY_IDX;
    }
