...
/* @title HaqqX conditional oracle interface
...
interface IHaqqXNonceOracle {
     ...
     *
     * @return True if the condition is met. If false, HaqqXSwap will revert the 
...
interface IHaqqXCondOracle {
    function checkHaqqXCond (address user, bytes calldata args) external returns (bool);
}
