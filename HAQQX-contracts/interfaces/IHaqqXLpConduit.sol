...
interface IHaqqXLpConduit {
     ...
     *                 minted on.
     * @param lowerTick The tick index of the lower range (0 if haqq liquidity)
     * @param upperTick The tick index of the upper range (0 if haqq liquidity)
     * @param liq       The amount of liquidity being minted. If haqq liquidity this
     *                  is denominated as haqq seeds. If concentrated this is flat
     *                  sqrt(X*Y) liquidity of the liquidity minted.
     * @param mileage   The accumulated fee mileage (see PositionRegistrar.sol) of the 
     *                  concentrated liquidity at mint time. If haqq, this is zero.
     *
