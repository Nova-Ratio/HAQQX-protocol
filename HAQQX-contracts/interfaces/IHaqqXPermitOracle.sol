 ...
 *      pool initialization, swaps, mints and burns for all liquidity types (haqq,
...
interface IHaqqXPermitOracle {
     ...
     * @param haqq The haqq liquidity directive for the pool action (possibly zero)
    ...
    function checkApprovedForHaqqXPool (address user, address sender,
                                       ...
                                       Directives.HaqqDirective calldata haqq,
     ...
     * @param base The base-side token in the pair.
     * @param quote The quote-side token in the pair.
     * @param bidTick  The tick index of the lower side of the range (0 if haqq)
     * @param askTick  The tick index of the upper side of the range (0 if haqq)
     * @param liq      The total amount of liquidity being minted. Denominated as 
     *                 sqrt(X*Y)
     *
     * @returns       Returns true if action is permitted. If false, HaqqXSwap will revert
     *                the transaction. */
     ...
     * @param base The base-side token in the pair.
     * @param quote The quote-side token in the pair.
     * @param poolIdx The HaqqX-specific pool type index the pool is being created on.
     *
     * @returns       Returns true if action is permitted. If false, HaqqXSwap will revert
